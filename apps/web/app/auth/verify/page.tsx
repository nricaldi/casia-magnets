  ...
  return (
    <section className={styles.authContainer}>
      ...
      <div className={`${styles.authCard} ${styles.wide}`}>
        ...
        <div className={styles.authTextGroup}>
          <p className={styles.authText}>Just click on the link in the email to complete your sign up. If you don&apos;t see it, you may need to <strong>check your spam</strong> folder.</p>
        </div>
        ...
        <Button size="lg" variant="dark">Resend</Button>
      </div>
